...
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Consulates[ENDCOLOR][NEWLINE]Resting point for [ICON_INFLUENCE] Influence with all City-States is increased by 15. The [COLOR_POSITIVE_TEXT]Civil Service[ENDCOLOR] boosts [ICON_GOLD] Gold production by 10%.'
