...
--==========================================================================================================================
INSERT INTO Buildings 	
			(Type, 						 					BuildingClass, 								Description,									Civilopedia,												Help,													Strategy,										GoldMaintenance, Cost, PrereqTech, 				NeverCapture,	IconAtlas, 				PortraitIndex)
VALUES		('BUILDING_DECISIONS_NATIONALCOURT', 			'BUILDINGCLASS_DECISIONS_NATIONALCOURT',	'TXT_KEY_DECISIONS_NATIONALCOURT',				'TXT_KEY_DECISIONS_NATIONALCOURT_CIVILOPEDIA',				'TXT_KEY_DECISIONS_NATIONALCOURT_HELP',					'TXT_KEY_DECISIONS_NATIONALCOURT_STRATEGY',		4, 100,  'TECH_CALENDAR',		1,				'CORE_DECISIONS_ATLAS',	1),
			('BUILDING_DECISIONS_CODEOFLAWS', 				'BUILDINGCLASS_DECISIONS_CODEOFLAWS',		'TXT_KEY_DECISIONS_BUILDING_CODEOFLAWS',		'TXT_KEY_DECISIONS_BUILDING_CODEOFLAWS_CIVILOPEDIA',		'TXT_KEY_DECISIONS_BUILDING_CODEOFLAWS_HELP',			null,											0, -1,   null,						1,				'CORE_DECISIONS_ATLAS',	1),
			('BUILDING_DECISIONS_PUBLICTRANSPORT', 			'BUILDINGCLASS_DECISIONS_PUBLICTRANSPORT',	'TXT_KEY_DECISIONS_BUILDING_PUBLICTRANSPORT',	'TXT_KEY_DECISIONS_BUILDING_PUBLICTRANSPORT_CIVILOPEDIA',	'TXT_KEY_DECISIONS_BUILDING_PUBLICTRANSPORT_HELP',		null,											0, -1,   'TECH_STEAM_POWER',		0,				'CORE_DECISIONS_ATLAS',	4);
...
VALUES		('BUILDING_PALACE', 							'RESOURCE_MAGISTRATES',	0, 			2),
			...
			('BUILDING_STONE_WORKS', 			'RESOURCE_MASONRY',	3, 			3),
			('BUILDING_CONCRETE', 			'RESOURCE_MASONRY',	3, 			3);
--==========================================================================================================================	
-- Building_Flavors
--==========================================================================================================================
