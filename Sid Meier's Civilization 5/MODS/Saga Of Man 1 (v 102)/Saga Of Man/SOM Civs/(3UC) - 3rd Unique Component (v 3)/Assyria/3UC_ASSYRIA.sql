...
INSERT INTO Units 	
		(Type, 						Class,	PrereqTech, RangedCombat, Range, Special, Combat, Cost, ObsoleteTech, GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, Moves, CombatClass, Domain, DefaultUnitAI, Help, Description, 					  Civilopedia, 								Strategy, 		 									Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, UnitArtInfo, 						UnitFlagIconOffset,	UnitFlagAtlas,						 PortraitIndex, 	IconAtlas,			 MoveRate)
SELECT	'UNIT_IA_3UC_ROYAL_GUARD',	Class,	'TECH_IRON_WORKING', RangedCombat, Range, Special, Combat, Cost, ObsoleteTech, GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, Moves, CombatClass, Domain, 'UNITAI_ATTACK', 'TXT_KEY_UNIT_3UC_ROYAL_GUARD_HELP','TXT_KEY_UNIT_3UC_ROYAL_GUARD_2', 'TXT_KEY_UNIT_3UC_ROYAL_GUARD_TEXT',	'TXT_KEY_UNIT_3UC_ROYAL_GUARD_STRATEGY',  	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_ROYAL_GUARD',	0,					'ROYAL_GUARD_FLAG',					  0, 				'ROYAL_GUARD_ATLAS',	 MoveRate
FROM Units WHERE Type = 'UNIT_SPEARMAN';
--------------------------------	
...
INSERT INTO UnitGameplay2DScripts 	
		(UnitType, 					SelectionSound, FirstSelectionSound)
SELECT	'UNIT_IA_3UC_ROYAL_GUARD', 	SelectionSound, FirstSelectionSound
FROM UnitGameplay2DScripts WHERE UnitType = 'UNIT_SPEARMAN';
--------------------------------		
-- Unit_AITypes
--------------------------------		
...
INSERT INTO Unit_AITypes 	
		(UnitType, 					UnitAIType)
VALUES	('UNIT_IA_3UC_ROYAL_GUARD',  'UNITAI_ATTACK');
--------------------------------	
-- Unit_ClassUpgrades
--------------------------------	
...
INSERT INTO Unit_ClassUpgrades 	
		(UnitType, 					UnitClassType)
SELECT	'UNIT_IA_3UC_ROYAL_GUARD',	UnitClassType
FROM Unit_ClassUpgrades WHERE UnitType = 'UNIT_SPEARMAN';	
--------------------------------	
-- Unit_Flavors
--------------------------------		
...
VALUES	('UNIT_3UC_ROYAL_GUARD',  'FLAVOR_OFFENSE', 4),
		...
		INSERT INTO Unit_Flavors 	
		(UnitType, 					FlavorType, Flavor)
VALUES	('UNIT_IA_3UC_ROYAL_GUARD',  'FLAVOR_OFFENSE', 4),
		('UNIT_IA_3UC_ROYAL_GUARD',  'FLAVOR_DEFENSE', 4);
--------------------------------	
...
INSERT INTO Unit_ResourceQuantityRequirements 	
		(UnitType, 					ResourceType, Cost)
SELECT	'UNIT_IA_3UC_ROYAL_GUARD', 	ResourceType, Cost
FROM Unit_ResourceQuantityRequirements WHERE UnitType = 'UNIT_SPEARMAN';
--------------------------------	
-- Unit_FreePromotions
--------------------------------	
...
INSERT INTO Unit_FreePromotions 	
		(UnitType, 					PromotionType)
SELECT	'UNIT_IA_3UC_ROYAL_GUARD', 	PromotionType
FROM Unit_FreePromotions WHERE UnitType = 'UNIT_SPEARMAN';	

INSERT INTO Unit_FreePromotions
		(UnitType, 					PromotionType)
VALUES	('UNIT_IA_3UC_ROYAL_GUARD',  'PROMOTION_ROYAL_GUARD');
...
INSERT INTO Civilization_UnitClassOverrides 
		(CivilizationType, 					UnitClassType, 			UnitType)
VALUES	('CIVILIZATION_ASSYRIA',	'UNITCLASS_SPEARMAN',	'UNIT_IA_3UC_ROYAL_GUARD');