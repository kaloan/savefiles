...
FROM Building_ResourceQuantityRequirements WHERE BuildingType = 'BUILDING_WINDMILL';
...
INSERT INTO Building_YieldModifiers 	
			(BuildingType, YieldType, Yield)
SELECT 'BUILDING_3UC_SALON', YieldType, Yield
FROM Building_YieldModifiers WHERE BuildingType = 'BUILDING_WINDMILL';

INSERT INTO Building_YieldModifiers 	
			(BuildingType, YieldType, Yield)
VALUES ('BUILDING_3UC_SALON', 'YIELD_SCIENCE', 10);
...
VALUES	('CIVILIZATION_FRANCE',	'BUILDINGCLASS_WINDMILL',	'BUILDING_3UC_SALON');
