...
INSERT INTO Units 	
		(Type, 						Class,	PrereqTech, RangedCombat, Range, Special, Combat, Cost, ObsoleteTech, GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, Moves, CombatClass, Domain, DefaultUnitAI, Help,  Description, 					  Civilopedia, 								Strategy, 		 									Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, UnitArtInfo, 						UnitFlagIconOffset,	UnitFlagAtlas,						 PortraitIndex, 	IconAtlas,			 MoveRate)
SELECT	'UNIT_BA_3UC_CLIBANARII',	Class,	'TECH_BRONZE_WORKING', RangedCombat, Range, Special, 16, Cost, ObsoleteTech, GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, 3, CombatClass, Domain, DefaultUnitAI, 'TXT_KEY_UNIT_3UC_CLIBANARII_HELP', 'TXT_KEY_UNIT_BA_3UC_CLIBANARII', 'TXT_KEY_UNIT_3UC_CLIBANARII_TEXT',	'TXT_KEY_UNIT_3UC_CLIBANARII_STRATEGY',  	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_U_BYZANTIUM_CATAPHRACT',	4,					'EXPANSION_UNIT_FLAG_ATLAS',					  0, 				'CLIBANARII_ATLAS',	 MoveRate
FROM Units WHERE Type = 'UNIT_HORSEMAN';
--------------------------------	
...
INSERT INTO UnitGameplay2DScripts 	
		(UnitType, 					SelectionSound, FirstSelectionSound)
SELECT	'UNIT_BA_3UC_CLIBANARII', 	SelectionSound, FirstSelectionSound
FROM UnitGameplay2DScripts WHERE UnitType = 'UNIT_HORSEMAN';
--------------------------------		
-- Unit_AITypes
--------------------------------		
...
INSERT INTO Unit_AITypes 	
		(UnitType, 					UnitAIType)
SELECT	'UNIT_BA_3UC_CLIBANARII', 	UnitAIType
FROM Unit_AITypes WHERE UnitType = 'UNIT_HORSEMAN';
...
INSERT INTO Unit_ClassUpgrades 	
		(UnitType, 					UnitClassType)
SELECT	'UNIT_BA_3UC_CLIBANARII',	UnitClassType
FROM Unit_ClassUpgrades WHERE UnitType = 'UNIT_HORSEMAN';	
--------------------------------	
-- Unit_Flavors
--------------------------------		
...
INSERT INTO Unit_Flavors 	
		(UnitType, 					FlavorType, Flavor)
SELECT	'UNIT_BA_3UC_CLIBANARII', 	FlavorType, Flavor
FROM Unit_Flavors  WHERE UnitType = 'UNIT_HORSEMAN';
...
INSERT INTO Unit_ResourceQuantityRequirements 	
		(UnitType, 					ResourceType, Cost)
SELECT	'UNIT_BA_3UC_CLIBANARII', 	'RESOURCE_BRONZE', Cost
FROM Unit_ResourceQuantityRequirements WHERE UnitType = 'UNIT_HORSEMAN';
...
INSERT INTO Unit_FreePromotions 	
		(UnitType, 					PromotionType)
SELECT	'UNIT_BA_3UC_CLIBANARII', 	PromotionType
FROM Unit_FreePromotions WHERE UnitType = 'UNIT_HORSEMAN';	

INSERT INTO Unit_FreePromotions
		(UnitType, 					PromotionType)
VALUES	('UNIT_BA_3UC_CLIBANARII',  'PROMOTION_SHOCK_1');
...
INSERT INTO Civilization_UnitClassOverrides 
		(CivilizationType, 					UnitClassType, 			UnitType)
VALUES	('CIVILIZATION_PERSIA',	'UNITCLASS_HORSEMAN',	'UNIT_BA_3UC_CLIBANARII');