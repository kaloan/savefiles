...
--------------------------------
INSERT INTO Units 	
		(Type, 						Class,	PrereqTech, RangedCombat, Range, Special, Combat, Cost, ObsoleteTech, GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, Moves, CombatClass, Domain, DefaultUnitAI,   Description, 		Help,			  Civilopedia, 								Strategy, 		 									Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, UnitArtInfo, 						UnitFlagIconOffset,	UnitFlagAtlas,						 PortraitIndex, 	IconAtlas,			 MoveRate)
SELECT	'UNIT_3UC_KHOPESH_SWORDSMAN',	Class,	'TECH_BRONZE_WORKING', RangedCombat, Range, Special, Combat, Cost, ObsoleteTech, GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, Moves, CombatClass, Domain, DefaultUnitAI, 'TXT_KEY_UNIT_3UC_KHOPESH_SWORDSMAN', 'TXT_KEY_UNIT_3UC_KHOPESH_SWORDSMAN_HELP',  'TXT_KEY_UNIT_3UC_KHOPESH_SWORDSMAN_TEXT',	'TXT_KEY_UNIT_3UC_KHOPESH_SWORDSMAN_STRATEGY',  	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_KHOPESH_SWORDSMAN',	0,					'KHOPESH_FLAG',					  0, 				'KHOPESH_ATLAS',	 MoveRate
FROM Units WHERE Type = 'UNIT_SWORDSMAN';

INSERT INTO Units 	
		(Type, 						Class,	PrereqTech, RangedCombat, Range, Special, Combat, Cost, ObsoleteTech, GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, Moves, CombatClass, Domain, DefaultUnitAI,   Description, 		Help,			  Civilopedia, 								Strategy, 		 									Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, UnitArtInfo, 						UnitFlagIconOffset,	UnitFlagAtlas,						 PortraitIndex, 	IconAtlas,			 MoveRate)
SELECT	'UNIT_IA_3UC_KHOPESH_SWORDSMAN',	Class,	'TECH_IRON_WORKING', RangedCombat, Range, Special, Combat, Cost, ObsoleteTech, GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, Moves, CombatClass, Domain, DefaultUnitAI, 'TXT_KEY_UNIT_3UC_IA_KHOPESH_SWORDSMAN', 'TXT_KEY_UNIT_3UC_KHOPESH_SWORDSMAN_HELP', 'TXT_KEY_UNIT_3UC_KHOPESH_SWORDSMAN_TEXT',	'TXT_KEY_UNIT_3UC_KHOPESH_SWORDSMAN_STRATEGY',  	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_KHOPESH_SWORDSMAN',	0,					'KHOPESH_FLAG',					  0, 				'KHOPESH_ATLAS',	 MoveRate
FROM Units WHERE Type = 'UNIT_SWORDSMAN';
--------------------------------	
...
INSERT INTO UnitGameplay2DScripts 	
		(UnitType, 					SelectionSound, FirstSelectionSound)
SELECT	'UNIT_IA_3UC_KHOPESH_SWORDSMAN', 	SelectionSound, FirstSelectionSound
FROM UnitGameplay2DScripts WHERE UnitType = 'UNIT_SWORDSMAN';
--------------------------------		
-- Unit_AITypes
--------------------------------		
...
INSERT INTO Unit_AITypes 	
		(UnitType, 					UnitAIType)
SELECT	'UNIT_IA_3UC_KHOPESH_SWORDSMAN', 	UnitAIType
FROM Unit_AITypes WHERE UnitType = 'UNIT_SWORDSMAN';
--------------------------------	
-- Unit_ClassUpgrades
--------------------------------	
...
INSERT INTO Unit_ClassUpgrades 	
		(UnitType, 					UnitClassType)
SELECT	'UNIT_IA_3UC_KHOPESH_SWORDSMAN',	UnitClassType
FROM Unit_ClassUpgrades WHERE UnitType = 'UNIT_SWORDSMAN';	
--------------------------------	
-- Unit_Flavors
--------------------------------		
...
INSERT INTO Unit_Flavors 	
		(UnitType, 					FlavorType, Flavor)
SELECT	'UNIT_IA_3UC_KHOPESH_SWORDSMAN', 	FlavorType, Flavor
FROM Unit_Flavors  WHERE UnitType = 'UNIT_SWORDSMAN';
--------------------------------	
...
VALUES	('UNIT_3UC_KHOPESH_SWORDSMAN',  'PROMOTION_SHOCK_1'),
		...
		INSERT INTO Unit_FreePromotions 	
		(UnitType, 					PromotionType)
SELECT	'UNIT_IA_3UC_KHOPESH_SWORDSMAN', 	PromotionType
FROM Unit_FreePromotions WHERE UnitType = 'UNIT_SWORDSMAN';	

INSERT INTO Unit_FreePromotions
		(UnitType, 					PromotionType)
VALUES	('UNIT_IA_3UC_KHOPESH_SWORDSMAN',  'PROMOTION_SHOCK_1'),
		('UNIT_IA_3UC_KHOPESH_SWORDSMAN',  'PROMOTION_DESERT_WARRIOR');
...
INSERT INTO Civilization_UnitClassOverrides 
		(CivilizationType, 					UnitClassType, 			UnitType)
VALUES	('CIVILIZATION_EGYPT',	'UNITCLASS_SWORDSMAN',	'UNIT_IA_3UC_KHOPESH_SWORDSMAN');