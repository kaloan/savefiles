...
SELECT	'BUILDING_3UC_GER', BuildingClass,  GreatWorkSlotType, GreatWorkCount, Cost, FreeStartEra, Happiness, NeverCapture, 2, PrereqTech, ArtDefineTag, SpecialistType, SpecialistCount, MinAreaSize, ConquestProb, HurryCostModifier,  'TXT_KEY_BUILDING_3UC_GER_HELP', 'TXT_KEY_BUILDING_3UC_GER', 'TXT_KEY_BUILDING_3UC_GER_TEXT', 'TXT_KEY_BUILDING_3UC_GER_STRATEGY', 'GER_ICON_ATLAS', 0
...
VALUES ('BUILDING_3UC_GER', 'DOMAIN_LAND', 10);
