...
SELECT	'BUILDING_4UC_ALTAR', BuildingClass, 1, Defense, ExtraCityHitPoints,CityWall,  Cost, GoldMaintenance, PrereqTech, ArtDefineTag, XBuiltTriggersIdeologyChoice, SpecialistType, SpecialistCount, MinAreaSize, ConquestProb, HurryCostModifier, 'TXT_KEY_BUILDING_4UC_ALTAR_HELP', 'TXT_KEY_BUILDING_4UC_ALTAR', 'TXT_KEY_BUILDING_4UC_ALTAR_TEXT', 'TXT_KEY_BUILDING_4UC_ALTAR_STRATEGY', 'SACRIFICIAL_ALTAR_ICON_ATLAS', 0
...
INSERT INTO Building_Flavors 	
		(BuildingType, 				FlavorType, Flavor)
	VALUES	('BUILDING_4UC_ALTAR',	'FLAVOR_HAPPINESS',	20);
------------------------------	
