...
--Improvements 
--------------------------------------------------------------------------------------------------
INSERT INTO Improvements (Type,		DestroyedWhenPillaged,	OutsideBorders,	Description,						Help,											Civilopedia,									ArtDefineTag,	DefenseModifier,					IconAtlas,			PortraitIndex,	 SpecificCivRequired,	 CivilizationType)
SELECT 'IMPROVEMENT_PLANT_FOREST_3UC',	1,						0,				'TXT_KEY_IMPROVEMENT_PLANT_FOREST_3UC',	'TXT_KEY_CIV5_IMPROVEMENTS_PLANT_FOREST_HELP_3UC',	'TXT_KEY_CIV5_IMPROVEMENTS_PLANT_FOREST_TEXT_3UC',	'ART_DEF_IMPROVEMENT_PLANT_FOREST_3UC', 50,	'REFOREST_ATLAS_3UC',	0,				'true',					 'CIVILIZATION_IROQUOIS';

--------------------------------------------------------------------------------------------------
--Improvement Yields
--------------------------------------------------------------------------------------------------
INSERT INTO Improvement_Yields (ImprovementType,		YieldType,				Yield)
SELECT 'IMPROVEMENT_PLANT_FOREST_3UC',						'YIELD_CULTURE',		1 UNION ALL
SELECT 'IMPROVEMENT_PLANT_FOREST_3UC',						'YIELD_FAITH',		1 UNION ALL
...
--Builds 
--------------------------------------------------------------------------------------------------
INSERT INTO Builds (Type,					Time,	ImprovementType,			Description,			Help,							Recommendation,				EntityEvent,				HotKey,		OrderPriority,	IconAtlas,						IconIndex)
SELECT 'BUILD_FOREST_3UC',				900,	'IMPROVEMENT_PLANT_FOREST_3UC',	'TXT_KEY_BUILD_FOREST_3UC',	'TXT_KEY_BUILD_FOREST_HELP_3UC',	'TXT_KEY_BUILD_FOREST_REC_3UC',	'ENTITY_EVENT_IRRIGATE',	'KB_F',		37,				'UNIT_ACTION_REFOREST_ATLAS_3UC',	0;
...
INSERT INTO Unit_Builds (UnitType,	BuildType) 
SELECT	Type, 'BUILD_FOREST_3UC'
FROM Units WHERE Class = 'UNITCLASS_MODERN_WORKER';
...
CREATE TRIGGER ReforestationMod_01
AFTER INSERT ON Units
WHEN NEW.Class = 'UNITCLASS_MODERN_WORKER' 
BEGIN
	INSERT INTO Unit_Builds (NEW.Type,	'BUILD_FOREST_3UC')
END;