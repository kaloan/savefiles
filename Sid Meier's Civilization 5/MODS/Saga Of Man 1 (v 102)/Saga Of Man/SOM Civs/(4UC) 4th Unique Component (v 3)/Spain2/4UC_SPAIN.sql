...
INSERT INTO Buildings 	
	(Type, BuildingClass, ExtraMissionarySpreads, ReligiousPressureModifier, GreatPeopleRateModifier,  AllowsRangeStrike, Defense, ExtraCityHitPoints, CityWall, Cost, GoldMaintenance, PrereqTech, ArtDefineTag, XBuiltTriggersIdeologyChoice, SpecialistType, SpecialistCount, MinAreaSize, ConquestProb, HurryCostModifier, Help, Description, Civilopedia, Strategy, IconAtlas, PortraitIndex)
SELECT	'BUILDING_4UC_MISSION', BuildingClass, 1, 25, GreatPeopleRateModifier, AllowsRangeStrike, Defense, ExtraCityHitPoints,CityWall,  Cost, GoldMaintenance, PrereqTech, ArtDefineTag, XBuiltTriggersIdeologyChoice, SpecialistType, SpecialistCount, MinAreaSize, ConquestProb, HurryCostModifier, 'TXT_KEY_BUILDING_4UC_MISSION_HELP', 'TXT_KEY_BUILDING_4UC_MISSION', 'TXT_KEY_BUILDING_4UC_MISSION_TEXT', 'TXT_KEY_BUILDING_4UC_MISSION_STRATEGY', 'BUILDING_4UC_MISSION_ATLAS', 0
