...
SELECT	'UNIT_3CETBANG',	Class,	  PrereqTech, RangedCombat, Range, Special, Combat, Cost, ObsoleteTech, GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, 3, CombatClass, Domain, DefaultUnitAI, 'TXT_KEY_UNIT_3CETBANG_HELP', 'TXT_KEY_UNIT_3CETBANG', 'TXT_KEY_UNIT_3CETBANG_TEXT',	'TXT_KEY_UNIT_3CETBANG_STRATEGY',  	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_3CETBANG',	0,					'3CETBANG_FLAG',					  0, 				'3CETBANG_ATLAS',	 MoveRate
...
VALUES	('UNIT_3CETBANG',  'PROMOTION_EXTRA_SIGHT_I');
