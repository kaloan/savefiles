...
VALUES ('BUILDING_GUMBOOT_GUILD', 'RESOURCE_GOLD', 'YIELD_PRODUCTION', 1),
		...
		('BUILDING_GUMBOOT_GUILD', 'RESOURCE_SALTPETER', 'YIELD_PRODUCTION', 1),
		('BUILDING_GUMBOOT_GUILD', 'RESOURCE_COPPER2', 'YIELD_PRODUCTION', 1),
