...
SELECT	'BUILDING_3UC_TEXTILE', BuildingClass, 1,  Cost, GoldMaintenance, PrereqTech, ArtDefineTag, SpecialistType, SpecialistCount, MinAreaSize, ConquestProb, HurryCostModifier, 'TXT_KEY_BUILDING_3UC_TEXTILE_HELP', 'TXT_KEY_BUILDING_3UC_TEXTILE', 'TXT_KEY_BUILDING_3UC_TEXTILE_TEXT', 'TXT_KEY_BUILDING_3UC_TEXTILE_STRATEGY', '3UC_TEXTILE_ATLAS', 0
...
INSERT INTO Building_ResourceYieldChanges 	
			(BuildingType, ResourceType, YieldType, Yield)
VALUES	('BUILDING_3UC_TEXTILE',	'RESOURCE_COTTON',	'YIELD_GOLD', 1),
		('BUILDING_3UC_TEXTILE',	'RESOURCE_DYE',		'YIELD_GOLD', 1),
		('BUILDING_3UC_TEXTILE',	'RESOURCE_SILK',	'YIELD_GOLD', 1);
