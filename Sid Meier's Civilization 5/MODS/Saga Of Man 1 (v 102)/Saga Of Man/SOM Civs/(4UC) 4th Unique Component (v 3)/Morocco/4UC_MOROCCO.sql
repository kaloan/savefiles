...
SELECT	'BUILDING_4UC_ZELLIGE_TEMPLE', BuildingClass, AllowsRangeStrike, Defense, ExtraCityHitPoints,CityWall,  Cost, 2, PrereqTech, ArtDefineTag, XBuiltTriggersIdeologyChoice, SpecialistType, SpecialistCount, MinAreaSize, ConquestProb, HurryCostModifier, 'TXT_KEY_BUILDING_4UC_ZELLIGE_TEMPLE_HELP', 'TXT_KEY_BUILDING_4UC_ZELLIGE_TEMPLE', 'TXT_KEY_BUILDING_4UC_ZELLIGE_TEMPLE_TEXT', 'TXT_KEY_BUILDING_4UC_ZELLIGE_TEMPLE_STRATEGY', 'ZELLIGE_TEMPLE_ATLAS', 0
...
INSERT INTO Building_YieldModifiers 	
			(BuildingType, YieldType, Yield)
VALUES ('BUILDING_4UC_ZELLIGE_TEMPLE', 'YIELD_CULTURE', 15);
