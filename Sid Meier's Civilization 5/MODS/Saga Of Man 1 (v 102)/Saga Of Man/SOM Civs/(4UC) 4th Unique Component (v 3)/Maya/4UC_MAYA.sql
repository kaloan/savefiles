...
INSERT INTO ArtDefine_UnitMemberInfos (Type, Scale, ZOffset, Domain, Model, MaterialTypeTag, MaterialTypeSoundOverrideTag)
	SELECT	('ART_DEF_UNIT_MEMBER_3MAYAN_SWORDSMAN_1'), Scale, ZOffset, Domain, ('Longswordsman_Maya.fxsxml'), MaterialTypeTag, MaterialTypeSoundOverrideTag
...
SELECT	'UNIT_3MAYAN_SWORDSMAN',	Class,	  'TECH_BRONZE_WORKING', RangedCombat, Range, Special, 13, Cost, ObsoleteTech, 'UNITCLASS_SWORDSMAN', FaithCost, RequiresFaithPurchaseEnabled, Moves, CombatClass, Domain, DefaultUnitAI, 'TXT_KEY_UNIT_3MAYAN_SWORDSMAN_HELP','TXT_KEY_UNIT_3MAYAN_SWORDSMAN', 'TXT_KEY_UNIT_3MAYAN_SWORDSMAN_TEXT',	'TXT_KEY_UNIT_3MAYAN_SWORDSMAN_STRATEGY',  	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_3MAYAN_SWORDSMAN',	0,					'3MAYAN_FLAG',					  0, 				'3MAYAN_SWORDSMAN_ATLAS',	 MoveRate
...
INSERT INTO Unit_AITypes 	
		(UnitType, 					UnitAIType)
VALUES ('UNIT_3MAYAN_SWORDSMAN', 'UNITAI_ATTACK');
...
VALUES ('UNIT_3MAYAN_SWORDSMAN', 'UNITCLASS_LONGSWORDSMAN');	
--------------------------------	
-- Unit_Flavors
--------------------------------		
...
VALUES	('UNIT_3MAYAN_SWORDSMAN',	'FLAVOR_OFFENSE', 4),
		('UNIT_3MAYAN_SWORDSMAN',	'FLAVOR_DEFENSE', 5);
...
VALUES	('UNIT_3MAYAN_SWORDSMAN',  'PROMOTION_ANTI_MOUNTED_3UC');
