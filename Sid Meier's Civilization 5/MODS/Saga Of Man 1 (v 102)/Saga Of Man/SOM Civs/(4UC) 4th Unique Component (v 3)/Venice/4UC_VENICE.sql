...
SELECT	'BUILDING_3DOGEPALACE', BuildingClass, NeverCapture, GreatWorkSlotType, GreatWorkCount, Capital, 800, ArtInfoCulturalVariation, NukeImmune,  Cost, GoldMaintenance, PrereqTech, ArtDefineTag, XBuiltTriggersIdeologyChoice, SpecialistType, SpecialistCount, MinAreaSize, ConquestProb, HurryCostModifier, 'TXT_KEY_BUILDING_3DOGEPALACE_HELP', 'TXT_KEY_BUILDING_3DOGEPALACE', 'TXT_KEY_BUILDING_3DOGEPALACE_TEXT', 'TXT_KEY_BUILDING_3DOGEPALACE_STRATEGY', '3DOGEPALACE_ATLAS', 0
...
INSERT INTO Building_YieldChanges 	
		(BuildingType, 				YieldType, Yield)
VALUES ('BUILDING_3DOGEPALACE',	'YIELD_CULTURE', 2);
